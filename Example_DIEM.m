...
%Last Version --- November 13th, 2024
%Code prepared by Federico Tessari, PhD at MIT

%To compute the DIEM between 2 hyper-dimensional points (or a matrix of
%them) you first need to compute the statistical distribution of your
%considered system.

%This involve setting the following quantities:
...
%Set Figure Flag to '1' if you want to have also a graphical representation
