...
if strcmpi(plotToggle, 'on') %if plot is on, use plotDIEM function to plot the Cosine Similarities.
...
% TessariSimilarity = abs(TessariSimilarity); %convert to absolute value.
[m,n] = size(DIEM);
